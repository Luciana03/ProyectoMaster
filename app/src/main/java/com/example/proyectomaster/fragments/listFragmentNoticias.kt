...
class listFragmentNoticias : Fragment() {
    ...
    override fun onStart() {
        ...
        noticias.add(noticia("Titulo de la noticia2","Cuerpo de la noticia2","Yo2","30 de mayo2","https://picsum.photos/200"))
        noticias.add(noticia("Titulo de la noticia3","Cuerpo de la noticia3","Yo3","30 de mayo3","https://picsum.photos/200"))
        noticias.add(noticia("Titulo de la noticia4","Cuerpo de la noticia4","Yo4","30 de mayo4","https://picsum.photos/200"))
